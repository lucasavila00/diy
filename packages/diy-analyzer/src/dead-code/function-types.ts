...
import { hasLocalTypeAlias, resolveLocalTypeAlias } from "../core/scoped-aliases.ts";
...
function getFunctionTypeFirstParamInfoInner(
	...
	/* c8 ignore next -- parenthesized contextual callback types are a defensive parser shape. */
